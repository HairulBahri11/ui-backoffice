        ...
        <div class="panel-header bg-primary-gradient" style="background:#01c293 !important">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Teacher's Reminders</h2>
                    </div>
                    <div class="ml-md-auto py-2 py-md-0">
                        {{-- Assuming the route for creating a reminder is 'teacher-reminder/create' --}}
                        <a href="{{ url('/teacher-reminder/create') }}" class="btn btn-secondary btn-round">Add Data</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Teacher's Reminders Data</h4>
                        </div>
                        <div class="card-body">
