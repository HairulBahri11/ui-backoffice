        ...
        <div class="modal-content shadow-lg border-0 rounded-lg">
            ...
            <div class="modal-header bg-primary text-white p-3 rounded-top-lg">
                <h5 class="modal-title font-weight-bold" id="assistModalLabel">
                    <i class="fas fa-edit mr-2"></i> Edit Assignment/Teacher
                </h5>
            ...
            {{-- Form Body --}}
            <form action="#" method="POST" id="formAssistSelection">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4 p-3 border rounded-lg bg-light">
                        <label for="new_teacher_id" class="font-weight-bold text-dark d-block">
                            <i class="fas fa-user-tie mr-1"></i> Select New Teacher
                        </label>
                        <p class="text-secondary small mb-2">Current Teacher: <span id="current_teacher_name" class="font-weight-medium">N/A</span></p>
                        <select class="form-control custom-select" id="new_teacher_id" name="new_teacher_id">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card p-3 h-100 border-info">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="clear_day1" value="1" id="clear_day1_check" class="custom-control-input">
                                    ...
                                    <span class="d-block text-sm text-muted current-day-status mt-1">
                                        Current: <span id="current_day1" class="font-weight-medium">N/A</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card p-3 h-100 border-info">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="clear_day2" value="1" id="clear_day2_check" class="custom-control-input">
                                    <label class="custom-control-label font-weight-bold text-info" for="clear_day2_check">
                                        Day 2
                                    </label>
                                    <span class="d-block text-sm text-muted current-day-status mt-1">
                                        Current: <span id="current_day2" class="font-weight-medium">N/A</span>
                                    </span>
                                </div>
                            </div>
                        </div>
