...
@section('content')
    <div class="content">
                ...
                <div class="">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item text-white">
                            <a href="#" class="text-white">Reminders</a>
                        </li>
                        <li class="separator text-white">
                            <i class="flaticon-right-arrow text-white"></i>
                        </li>
        ...
        <div class="page-inner mt--5">
            ...
            <div class="row">
                <div class="col-md-12">
                    {{-- Sesuaikan rute aksi form ke 'reminders.store' atau 'reminders.update' --}}
                    <form
                        action="{{ $data->type == 'create' ? route('teacher-reminder.store') : route('teacher-reminder.update', $data->id) }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ $data->type == 'create' ? 'Add Reminder' : 'Edit Reminder' }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    {{-- FIELD: teacher_id --}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('category') is-invalid @enderror" name="category" id="category">
                                                ...
                                                @php $categories = ['Arrival', 'Pre Teaching', 'Teaching', 'Post Teaching', 'Others']; @endphp
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ url('/teacher-reminder') }}"><button type="button" class="btn btn-success">Yes</button></a>
