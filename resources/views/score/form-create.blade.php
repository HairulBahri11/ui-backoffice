                                                ...
                                                @endforeach -->
                                                    ...
                                                    <tr style="height: 40px!important">
                                                        ...
                                                        <td style="height: 40px!important; padding: 8px 16px!important;">
                                                            <input type="hidden" value="{{ $itValue->id }}"
                                                                name="items[]">
                                                            {{-- FIX: Use data_get to safely retrieve ID, defaults to empty string if key is missing --}}
                                                            <input type="hidden" name="idScore[]"
                                                                id="idScore{{ $no }}"
                                                                value="{{ data_get($detail, "$itKey.id", '') }}">

                                                            {{-- FIX: Use data_get to safely retrieve score, defaults to empty string if key is missing --}}
                                                            <input type="number" id="{{ 'score' . $no }}" name="score[]"
                                                                required class="form-table score"
                                                                value="{{ data_get($detail, "$itKey.score", '') }}">
                                                        </td>
                                                        <td
                                                            style="height: 40px!important; padding: 8px 16px!important; text-align:center;">
                                                            <h6 id="grade{{ $no }}">
                                                                {{-- FIX: Safely retrieve score and then calculate grade --}}
                                                                @php
                                                                $currentScore = data_get($detail, "$itKey.score");
                                                                @endphp
                                                                {{ $currentScore != null ? Helper::getGrade($currentScore) : '' }}
                                                            </h6>
                                                        </td>
                                                    </tr>
                                                    @php
